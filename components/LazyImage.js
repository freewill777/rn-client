...
import { Image, Animated, Easing, StyleSheet, View, Text } from 'react-native';
        ...
        return (
            ...
            >
                {isLoading && (
                    ...
                    //     {customPlaceholder || <View style={[styles.placeholder, { backgroundColor: placeholderColor || '#e3e3e3' }]} />}
                    // </View>
                )}
                <Image
